...
from core.utils import register_all_crud_views
...
urlpatterns = [
    ...
    path('', RedirectView.as_view(url='/administracion/', permanent=False)),
...
register_all_crud_views()  # Registra todas las vistas CRUD al iniciar el servidor